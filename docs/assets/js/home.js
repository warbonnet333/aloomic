function weDoShowMore() {
  document.getElementById('we-do-show-more').classList.add('active');
  document.getElementById('weDoButton').classList.add('active');
}
...
console.log('hello');
/*! For license information please see home.js.LICENSE.txt */ !(function (b) {
  var c = {};
  function a(d) {
      ...
      document
        ...
        .addEventListener('click', (a) => {
          a.preventDefault(),
            ...
            (document.querySelector('.we-do__more-btn').style.visibility =
              'hidden');
        });
    class dj {
      constructor() {
